...
export default function Aboutuspage() {
    return (
        <section className="min-h-[calc(100dvh-165px)] px-3 sm:px-4 lg:px-6 bg-center relative bg-cover">
            <div className=" mx-auto bg-cover bg-top bg-repeat w-full h-full absolute left-0 right-0 top-[0rem] opacity-[.7]" style={{ backgroundImage: `url("/images/Games/Call-of-duty.jpg")` }}>
                <div className={`${styles['background-linear']}`}></div>
            </div>
            <div className="relative text-center py-10 text-3xl md:text-5xl lg:text-7xl font-bold leading-tight text-white">
                World Wire, <br />Game Online Center
            </div>
            <div className="relative text-white flex items-center justify-center md:justify-start pt-5 md:pt-20 lg:pt-10">
                <div className="text-center md:text-left max-w-4xl">
                    <p className="mt-4 test-sm md:text-lg max-w-full md:max-w-[80%] lg:max-w-[60%] font-bold text-white">About us</p>
                    <p className="mt-4 text-sm md:text-lg md:text-white max-w-full md:max-w-[80%] lg:max-w-[60%] font-bold">
